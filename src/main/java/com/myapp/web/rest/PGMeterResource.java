...
public class PGMeterResource {
    ...
    public PGMeterResource(PGMeterRepository pGMeterRepository) {
    ...
    public ResponseEntity<PGMeter> createPGMeter(@RequestBody PGMeter pGMeter) throws URISyntaxException {
        ...
        PGMeter result = pGMeterRepository.save(pGMeter);
    ...
    public ResponseEntity<PGMeter> partialUpdatePGMeter(
        ...
        Optional<PGMeter> result = pGMeterRepository
     ...
     */
    @GetMapping("")
    public List<PGMeter> getAllPGMeters() {
        log.debug("REST request to get all PGMeters");
    ...
    public ResponseEntity<PGMeter> getPGMeter(@PathVariable Long id) {
        ...
        Optional<PGMeter> pGMeter = pGMeterRepository.findById(id);
